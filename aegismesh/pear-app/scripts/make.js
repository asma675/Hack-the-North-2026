...
// Minimal build — AegisMesh Sovereign ships as JavaScript on Pear Runtime.
...
console.log(`=== Building AegisMesh Sovereign for ${target} ===`);
...
console.log('=== Next: pear build --package=./package.json --' + target + '-app ./out/' + target + '/aegismesh --target ../release ===');
