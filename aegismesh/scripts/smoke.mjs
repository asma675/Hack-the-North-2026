...
try { fs.unlinkSync('/tmp/vanguard-smoke.json'); } catch {}
const api=spawn(process.execPath,['server/dev-api.mjs'],{env:{...process.env,API_PORT:'8799',AUTH_SECRET:'smoke-secret',DATA_FILE:'/tmp/vanguard-smoke.json'},stdio:['ignore','pipe','pipe']});
...
try{
 ...
 console.log('Vanguard full-stack backend smoke test: PASS');
