...
export default function Register() {
  ...
  const googleEnabled = appPublicSettings?.public_settings?.google_oauth_enabled === true;
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      setDevOtp(result?.dev_otp || devOtp);
      toast({
        title: "Code sent",
  ...
  if (showOtp) {
    return (
      ...
      >
        ...
        {devOtp && <div className="mb-4 p-3 border border-primary/30 bg-primary/5 text-xs text-center"><span className="text-muted-foreground">Local demo verification code:</span> <span className="font-mono text-primary font-bold">{devOtp}</span></div>}
